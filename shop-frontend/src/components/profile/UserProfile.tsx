                    ...
                    <ul
                        ...
                        <li className="flex items-center py-3">
                            ...
                            <span className="ml-auto"><span
                                    className="bg-green-500 py-1 px-2 rounded text-white text-sm">Активний</span></span>
                        </li>
                        <li className="flex items-center py-3">
                            <span>Зареєстрованний:</span>
                            <span className="ml-auto">Квітень 06, 2023</span>
                        </li>
                    </ul>
                </div>
                {/* <!-- End of profile card --> */}
                    ...
                    <div className="text-gray-700">
                        <div className="grid md:grid-cols-2 text-sm">
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="px-4 py-2">+38 {(user?.phone) ?user?.phone :"(000) 000 00 00"}</div>
                            </div>
                            <div className="grid grid-cols-2">
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="px-4 py-2">
                                    <a className="text-blue-800" href={user?.email}>{user?.email}</a>
                                </div>
                            </div>
                            <div className="grid grid-cols-2">
