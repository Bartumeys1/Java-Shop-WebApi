...
//        try {
//            var product = _productMapper.ProductByProductCreateDTO(model);
//
//            product.setCategory(new CategoryEntity(model.getCategory_id()));
//            product.setDateCreated(new Date());
//            _productRepository.save(product);
//            var productItem = _productMapper.ProductItemDTOByProductEntity(product);
//            return productItem;
//        } catch (Exception ex) {
//            return null;
//        }
    ...
    public List<ProductItemDTO> get() {
        ...
        for (ProductEntity productEntity:list) {
            ...
            item.setCategory(productEntity.getCategory().getName());
            resultList.add(item);
        }
        return resultList;
    }
